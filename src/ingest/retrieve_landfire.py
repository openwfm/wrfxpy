...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        print('Usage: wrfx retrieve_landfire min_lon,max_lon,min_lat,max_lat')
        print('Example: wrfx retrieve_landfire -112.8115,-112.1661,39.4820,39.9750')
        sys.exit(-1)
    else:
        ...
        if len(coords) == 4:
            ...
            print('Usage: wrfx retrieve_landfire min_lon,max_lon,min_lat,max_lat')
            print('Example: wrfx retrieve_landfire -112.55,-112.4,39.65,39.8')
            sys.exit(-1)
