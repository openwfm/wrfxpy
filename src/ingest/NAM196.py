...
class NAM196(GribForecast):
    """
    The NAM (North American Mesoscale for Hawaii) 196 grib source as provided by NOMADS (6km resolution).
    """

    def __init__(self, arg):
        super(NAM196, self).__init__(arg)
    ...
    def namelist_keys(self):
        ...
        NAM 196 requires that ''num_metgrid_soil_levels'' is set to 4.
        """
    ...
    def file_names(self, cycle_start, fc_list):
        ...
        path_tmpl = 'nam.%04d%02d%02d/nam.t%02dz.hawaiinest.hiresf%02d.tm00.grib2'
    ...
    info_text = "NAM NEST over Hawaii (6 km Resolution - Grid 196)"
    info = "North American Mesoscale (NAM) Forecast System Grid 196"
    ...
    #    NAM196 provides hourly GRIB2 files up to 60.
