...
_var_wisdom = {
   ...
   'WINDSPD_mph_D' : {
      ...
      'colormap' : 'jet',
      'norm_opt' : 'boundary',
      'bounds' : [0, 2.2352, 4.4704, 6.7056, 8.9408, 11.176, 13.4112, 17.8816, 22.352],
   ...
   'HDW' : {
      ...
      'colors' : np.array([(255,255,255),(254,239,180),(254, 200, 108),
                           (243, 147, 70),(198, 104, 54),(135, 81, 56)])/255.,
      'spacing' : 'uniform',
      'scale' : [0, 100],
