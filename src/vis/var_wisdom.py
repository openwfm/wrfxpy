...
_var_wisdom = {
   ...
   'VR_SFC' : {
      ...
      'bounds' : [0, 1, 3, 5],
      'colors' : np.array([
         (147,32,205), (188,28,32), (249,201,80),
         (107,170,213)
      ])/255.,
      'spacing' : 'uniform',
      'transparent_values' : [-np.inf, 0],
   ...
   'FLINEINT_btupftps' : {
      ...
      'norm_opt' : 'boundary',
      'bounds' : [
         0., 346413.9231, 1732069.615, 3464139.231, 17320696.15,
   ...
   'ROS_chsph' : {
      ...
      'norm_opt' : 'boundary',
      'bounds' : [
         0., 0.011175999, 0.027939997, 0.11175999, 0.279399974,
   ...
   'WINDSPD_mph_D' : {
      ...
      'norm_opt' : 'boundary',
      'bounds' : [
         0, 2.2352, 4.4704, 6.7056, 8.9408, 11.176, 13.4112, 17.8816, 22.352
      ],
      'colors' : np.array([
